...
async def list_models() -> JSONResponse:
    return JSONResponse(content={"data": [{"id": "gpt-4-32k", "name": "Your model"}]})
...
if __name__ == "__main__":
    ...
    uvicorn.run("main_proxy:app", host="127.0.0.1", port=int(os.environ.get("PORT", "8001")),
